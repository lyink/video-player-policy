    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('db_engine', models.CharField(default='django.db.backends.sqlite3', max_length=100)),
                ('db_name', models.CharField(default='db.sqlite3', max_length=255)),
                ('db_host', models.CharField(blank=True, max_length=255)),
                ('db_port', models.CharField(blank=True, max_length=10)),
